...
const App = () => {
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      if (error.message === "MISSING_API_KEY") {
        errorMessage =
          "Configuration Error: API Key is missing or invalid. Please check your .env file.";
        ...
        errorMessage =
          "API access forbidden. Please check API key permissions.";
      ...
      >
        ...
        <div
          ...
          ${
            isUser
              ? isDarkMode
                ? "glass-user-message-dark rounded-br-none"
                : "glass-user-message-light rounded-br-none"
              : isDarkMode
              ? "glass-bot-message-dark rounded-bl-none"
              : "glass-bot-message-light rounded-bl-none"
          } 
          ${
            !isUser && !showAvatar ? "ml-10 sm:ml-16" : ""
  ...
  return (
    ...
    >
      ...
      <button
        ...
        title={
          isInitialTyping
            ...
            : "Switch to Myanmar Mode"
        }
      >
        <div
          className={`w-8 sm:w-10 h-6 sm:h-8 rounded-full shadow-md transform transition-transform duration-300 flex items-center justify-center ${
      ...
      <div
        className={`flex flex-col w-full max-w-3xl h-[90vh] sm:h-[80vh] shadow-xl rounded-2xl sm:rounded-3xl overflow-hidden transition-all duration-300 ${
      ...
      >
        ...
        >
          <div className="flex items-center">
            ...
            <div className="min-w-0 flex-1">
              ...
              >
                Thandar Soe (Licensed Real Estate Realtor)
              </h1>
              <p
        ...
        <main
          className={`flex-1 overflow-y-auto p-3 sm:p-6 space-y-3 sm:space-y-4 transition-all duration-300 ${
        ...
        >
          ...
          {loading && (
            <div className="flex justify-start mb-4 items-start">
              ...
              />
              <div
                className={`p-3 sm:p-4 rounded-2xl sm:rounded-3xl max-w-[85%] sm:max-w-xl rounded-bl-none transition-all duration-300 ${
        ...
        <footer
          className={`p-3 sm:p-6 border-t transition-all duration-300 ${
            isDarkMode
              ? "glass-footer-dark border-gray-600"
              : "glass-footer-light border-gray-200"
          }`}
        >
          <form
